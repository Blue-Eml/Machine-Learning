...
This R Markdown file includes my completion of ISLR chapter 8, exercises 7 and 9.


- Random Forest Models: Finding the best model to predict housing prices. 
- Decision Tree Models: Predict customer purchase of Orange Juice brands. 

    - Create a training set with a random sample and fit a tree to it. 
    - Finding which tree size has the lowest cross-validated classification error rate. 
    - Producing pruned tree with optimal tree using cross validation. 
...
Determine optimal tree size for the training set. Produce a plot of tree size and cross-validated classification error rate. 
